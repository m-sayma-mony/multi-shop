...
<body>
    ...
    <script src="{{asset('/')}}assets/frontend-assets/lib/owlcarousel/owl.carousel.min.js"></script>

    <!-- Contact Javascript File -->
    <script src="{{asset('/')}}assets/frontend-assets/mail/jqBootstrapValidation.min.js"></script>
    <script src="{{asset('/')}}assets/frontend-assets/mail/contact.js"></script>
